Generate and install the app icon for /tmp/sharpshot-digital-edge.
...
/tmp/sharpshot-digital-edge/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/sharpshot-digital-edge/app/src/main/res/drawable/icon.png`.
